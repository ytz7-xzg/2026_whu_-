...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='管理员权限表';
...
CREATE TABLE `login_log` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=436 DEFAULT CHARSET=utf8mb4 COMMENT='登录日志表';
...
CREATE TABLE `category` (
  ...
  `user_id` bigint NOT NULL COMMENT '创建该分类的用户ID',
...
CREATE TABLE `note` (
  ...
  `content` longtext COMMENT '笔记正文',
  `user_id` bigint NOT NULL COMMENT '创建该笔记的用户ID',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
-- ----------------------------
-- Table structure for note_category_relation
-- ----------------------------
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='笔记与分类的关联表';
